...
public class GuiSFHelpSlotCommands extends GuiSlot {
    final GuiSFHelp field_27276_a;

    public GuiSFHelpSlotCommands(GuiSFHelp guisfhelp)
    {
    ...
    {
        String str = GuiSFHelp.commands.get(i);
        field_27276_a.drawString(GuiSFHelp.getFontRenderer1(field_27276_a),str, j + 2, k + 1, i % 2 != 0 ? 0x909090 : 0xffffff);
        String s = "testing";
