...
public class GuiIngame extends Gui
{
    ...
    public GuiSFQuestion questionGui = null;
    public void addChatMessage(String s)
    {
    	if(s.toLowerCase().startsWith("񗉱�2/askgui")){
    		questionGui = new GuiSFQuestion("Loading", "Press ESC to cancel", "Loading", "Loading", "loading", "loading");
    		mc.displayGuiScreen(questionGui);
    		return;
    	}
    	if(questionGui != null){
    		if(s.toLowerCase().startsWith("񗉱�2/msg1=")){
    			questionGui.setMsg1(s.replaceFirst("񗉱�2/msg1=", ""));
    			return;
    		}
    		if(s.toLowerCase().startsWith("񗉱�2/msg2=")){
    			questionGui.setMsg2(s.replaceFirst("񗉱�2/msg2=", ""));
    			return;
    		}
    		if(s.toLowerCase().startsWith("񗉱�2/btn1=")){
    			questionGui.setBtn1(s.replaceFirst("񗉱�2/btn1=", ""));
    			return;
    		}
    		if(s.toLowerCase().startsWith("񗉱�2/btn2=")){
    			questionGui.setBtn2(s.replaceFirst("񗉱�2/btn2=", ""));
    			return;
    		}
    		if(s.toLowerCase().startsWith("񗉱�2/btn1cmd=")){
    			questionGui.setBtn1Cmd(s.replaceFirst("񗉱�2/btn1cmd=", ""));
    			return;
    		}
    		if(s.toLowerCase().startsWith("񗉱�2/btn2cmd=")){
    			questionGui.setBtn2Cmd(s.replaceFirst("񗉱�2/btn2cmd=", ""));
    			return;
    		}
    	}
        int i;
